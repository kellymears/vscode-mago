...
See [Binary Resolution](/docs/getting-started#binary-resolution) for the full search order.
...
<SettingMeta type="boolean" defaultValue="false" />
...
<SettingMeta type={'"off" | "error" | "warn" | "info" | "debug"'} defaultValue='"info"' />
